...
modulum('ApplicationTitleVMBehavior', ['BehaviorBase'],
  ...
  function(context, cls) {
     ...
     */
    cls.ApplicationTitleVMBehavior = context.oo.Class(cls.BehaviorBase, function($super) {
      ...
      return {
        ...
        _textNode: null,
        /**
         * @constructs {classes.ApplicationTitleVMBehavior}
        ...
        _apply: function() {
          ...
          this._textNode.getApplication().getUI().getWidget().getSidebarWidget().setApplicationName(text || name);
        },
