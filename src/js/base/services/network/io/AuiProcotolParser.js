// jshint ignore:start
"use strict";
modulum("AuiProtocolParser", [], function(context) {
  var txtEncode = function(t) {
    return t;
  };
  context.AuiProtocolParser = (function() {
    ...
    function peg$parse(input) {
      var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c17 = function(nodeType, nodeId, attrs, children) {
          return {
            id: nodeId,
            type: nodeType,
            attributes: attrs,
        ...
        peg$c51 = function(sign, firstdigit, digits) {
        ...
        peg$c54 = function(sign, digits, decimals) {
      ...
      function peg$buildException(message, expected, found, location) {
        ...
        function buildMessage(expected, found) {
          ...
          expectedDesc = expected.length > 1 ? expectedDescs.slice(0, -1).join(", ") + " or " + expectedDescs[expected.length - 1] :
            expectedDescs[0];
      ...
      if (peg$result !== peg$FAILED && peg$currPos === input.length) {
        ...
        throw peg$buildException(
          ...
          peg$maxFailPos < input.length ? peg$computeLocation(peg$maxFailPos, peg$maxFailPos + 1) : peg$computeLocation(
