...
modulum('ToolBarSeparatorController', ['ControllerBase', 'ControllerFactory'],
  ...
  function(context, cls) {
    /**
     * @class classes.ToolBarSeparatorController
     * @extends classes.ControllerBase
     */
    cls.ToolBarSeparatorController = context.oo.Class(cls.ControllerBase, function($super) {
      /** @lends classes.ToolBarSeparatorController.prototype */
      return {
        ...
        _createWidget: function() {
          return cls.WidgetFactory.create('ToolBarSeparator', this.getAnchorNode().attribute('style'));
        }
      };
    });
