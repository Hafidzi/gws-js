...
modulum('TopMenuSeparatorController', ['ControllerBase', 'ControllerFactory'],
  ...
  function(context, cls) {
    /**
     * @class classes.TopMenuSeparatorController
     * @extends classes.ControllerBase
     */
    cls.TopMenuSeparatorController = context.oo.Class(cls.ControllerBase, function($super) {
      /** @lends classes.TopMenuSeparatorController.prototype */
      return {
        ...
        _createWidget: function() {
          return cls.WidgetFactory.create('TopMenuSeparator', this.getAnchorNode().attribute('style'));
        }
      };
    });
