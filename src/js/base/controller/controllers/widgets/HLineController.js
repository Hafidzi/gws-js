    ...
    cls.HLineController = context.oo.Class(cls.ControllerBase, function($super) {
      ...
      return {
        ...
        _initBehaviors: function() {
          ...
          this._addBehavior(new cls.LayoutInfoVMBehavior(this, anchor, anchor));
          // END WARNING
        ...
        _createWidget: function() {
          return cls.WidgetFactory.create('HLine', this.getAnchorNode().attribute('style'));
        }
      };
    });
