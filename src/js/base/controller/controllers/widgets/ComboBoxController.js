    ...
    cls.ComboBoxController = context.oo.Class(cls.ValueContainerControllerBase, function($super) {
      ...
      return {
        ...
        _initBehaviors: function() {
          ...
          this._addBehavior(new cls.ItemVMBehavior(this, decorator));
        ...
        _createWidget: function(kind) {
          ...
          var comboBox = cls.WidgetFactory.create(resultId, this.getNodeBindings().decorator.attribute('style'));
          if (!!choices) {
